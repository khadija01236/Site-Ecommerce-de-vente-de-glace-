...
<html lang="fr">
  <head>
    ...
    <section class="section product-detail">
      <div class="details  ">
        <div class="left image-container">
          <div class="main">
            <img src="images/sor.jpeg" id="zoom" alt="Glace vanille" />
          </div>
        </div>
        <div class="right">
    ...
    <section class="section product-detail">
      <div class="details  ">
        <div class="left image-container">
          <div class="main">
            <img src="images/soro.png" id="zoom" alt="Glace chocolat" />
          </div>
        </div>
        <div class="right">
          <span>Accueil/Glace</span>
    ...
    <section class="section product-detail">
      <div class="details  ">
        <div class="left image-container">
          <div class="main">
            <img src="images/orange.jpeg" id="zoom" alt="Glace pistache" />
          </div>
        </div>
        <div class="right">
          <span>Accueil/Glace</span>
  ...
  <div class="details">
    <div class="left image-container">
      <div class="main">
        <img src="images/sorbet.jpeg" id="zoom" alt="Glace fraise" />
      </div>
    </div>
    <div class="right">
      <span>Accueil/Glace</span>
